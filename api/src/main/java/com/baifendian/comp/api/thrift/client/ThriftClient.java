package com.baifendian.comp.api.thrift.client;
...
public class ThriftClient {
  ...
  public QuartzService.Client getClient() throws TException{
    TTransport transport;

    transport = new TSocket(BizConfig.getHost(), Integer.parseInt(BizConfig.getPort()));
    transport.open();
...
//  public void returnClient(QuartzService){
//
//  }
